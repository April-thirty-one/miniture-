...
#ifndef MINIATURE_STL_ITERATOR_H
#define MINIATURE_STL_ITERATOR_H
...
#include <cstddef>
#include "type_traits"
#include "../01_allocators/type_traits.h"
...
public:
    ...
    // 重载操作符
    reference operator*() const     // 对应正向迭代器的前一个位置
    {
        auto temp = current;
        return * --temp;
    }
...
#endif //MINIATURE_STL_ITERATOR_H
