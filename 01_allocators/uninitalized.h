#ifndef MINIATURE_STL_UNINITALIZED_H
#define MINIATURE_STL_UNINITALIZED_H
...
template <typename InputIter, typename ForwardIter, typename Size>
ForwardIter unchecked_uninit_copy_n(InputIter first, ForwardIter result, Size n, std::false_type)
{
    auto cur = result;
    try 
    {
...
template <typename InputIter, typename ForwardIter, typename Size>
ForwardIter unchecked_uninit_copy_n(InputIter first, ForwardIter result, Size n)
{
    return unchecked_uninit_copy_n(first, result, n, std::is_trivially_copy_assignable<typename iterator_traits<InputIter>::value_type>{});
}
...
void unchecked_uninit_fill(ForwardIter first, ForwardIter last, const Type & value, std::true_type)
{
    mystl::fill(first, last, value);
}

template <typename ForwardIter, typename Type>
void unchecked_uninit_fill(ForwardIter first, ForwardIter last, const Type & value, std::false_type)
{
    auto cur = first;
    try 
    {
...
template <typename ForwardIter, typename Type>
void uninitialized_fill(ForwardIter first, ForwardIter last, const Type & value)
{
...
/*****************************************************************************************/
template <typename ForwardIter, typename Type, typename Size>
ForwardIter unchecked_uninit_fill_n(ForwardIter first, Size n, const Type & value, std::true_type)
{
    return mystl::fill_n(first, n, value);
}

template <typename ForwardIter, typename Type, typename Size>
ForwardIter unchecked_uninit_fill_n(ForwardIter first, Size n, const Type & value, std::false_type)
{
    auto cur = first;
    try
    {
...
ForwardIter uninitialized_fill_n(ForwardIter first, Size n, const Type & value)
{
...
#endif // end MINIATURE_STL_UNINITALIZED_H